...
{
    // alert(place.place_name + ", " + place.admin_name1);
    ...
    //     labelAnchor: new google.maps.Point(place.latitude, place.longitude - 20),
    //     labelClass: "labels",
    //     info: place
    //     });

    google.maps.event.addDomListener(marker, 'click', function() {
        // alert(marker.info.admin_name1);
        let parameters = {
            geo: marker.info.postal_code
        };
...
{
    // alert("Removing Markers");
    for (let i = 0; i < markers.length; i++)
    {
        // alert("Removing: " + markers[i].label.text);
